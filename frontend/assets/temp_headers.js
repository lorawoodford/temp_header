...
//           const projectId = $(this).closest('.record-pane').find('label[for=temp_header_project_id_]').siblings('div').text();
...
//     $.ajax({
//       url: self.frontendPrefix + "plugins/temp_headers/fetch_lc_project_data",
//       data: {
//         project_id: id,
//         use_cache: true
//       },
...
//     const self = this;
//     return $.ajax({
//       url: self.frontendPrefix + "plugins/temp_headers/reset_cache",
//       method: 'POST',
//       data: {
//         project_id: pid,
//         type: lc_type,
